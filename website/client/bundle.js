(function (factory) {
  ...
  var RequestMonitor = /*#__PURE__*/function () {
    function RequestMonitor(cb) {
    ...
    _createClass(RequestMonitor, [{
      ...
      value: function monitorXHR() {
        ...
        window.XMLHttpRequest.prototype.send = function () {
          var startTime = new Date().getTime(); // 记录请求开始时间

          this.addEventListener('load', function () {
            // 请求完成时的处理逻辑
            var responseTime = new Date().getTime() - startTime; // 计算响应时间
        ...
        var _init = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                //性能监控
                performanceFlag = this.config.performanceFlag;
